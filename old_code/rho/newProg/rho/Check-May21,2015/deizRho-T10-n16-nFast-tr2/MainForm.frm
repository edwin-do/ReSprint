...
Begin VB.Form frmMainForm 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         Tab(0).Control(15)=   "cmdRead"
         Tab(0).Control(15).Enabled=   0   'False
         Tab(0).Control(16)=   "tmrFastReading"
         Tab(0).Control(16).Enabled=   0   'False
         Tab(0).Control(17)=   "txtIntervalFastTimer"
         Tab(0).Control(17).Enabled=   0   'False
         Tab(0).Control(18)=   "cmdStartFastReading"
         Tab(0).Control(18).Enabled=   0   'False
         Tab(0).Control(19)=   "Command2"
         Tab(0).Control(19).Enabled=   0   'False
         Tab(0).Control(20)=   "Command3"
         Tab(0).Control(20).Enabled=   0   'False
         Tab(0).Control(21)=   "cmdSaveBuffer"
         Tab(0).Control(21).Enabled=   0   'False
         Tab(0).ControlCount=   22
         TabCaption(1)   =   "Program"
         TabPicture(1)   =   "MainForm.frx":0DEE
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "txtStopTime"
         Tab(1).Control(1)=   "txtCurrent"
         Tab(1).Control(2)=   "txtCompliance"
         Tab(1).Control(3)=   "txtDeltaCount"
         Tab(1).Control(4)=   "txtDelay"
         Tab(1).Control(5)=   "cboDigitalFilter"
         Tab(1).Control(6)=   "txtDigitalFilterCount"
         Tab(1).Control(7)=   "txtRate"
         Tab(1).Control(8)=   "cboAnalogFilter"
         Tab(1).Control(9)=   "cboVoltageRange"
         Tab(1).Control(10)=   "VScroll1"
         Tab(1).Control(11)=   "txtDataPoints"
         Tab(1).Control(12)=   "Command6"
         Tab(1).Control(13)=   "Command7"
         Tab(1).Control(14)=   "lstSchedulle"
         Tab(1).Control(15)=   "Label2"
         Tab(1).Control(16)=   "Label1"
         Tab(1).Control(17)=   "Label41"
         Tab(1).Control(18)=   "Label40"
         Tab(1).Control(19)=   "Label39"
         Tab(1).Control(20)=   "Label38"
         Tab(1).Control(21)=   "Label37"
         Tab(1).Control(22)=   "Label36"
         Tab(1).Control(23)=   "Label35"
         Tab(1).Control(24)=   "Label34"
         Tab(1).Control(25)=   "Label33"
         Tab(1).Control(26)=   "Label32"
         Tab(1).Control(27)=   "Label27"
         Tab(1).Control(28)=   "Label25"
         Tab(1).Control(29)=   "Label4(0)"
         Tab(1).Control(30)=   "Label5"
         Tab(1).ControlCount=   31
         Begin VB.CommandButton cmdSaveBuffer 
            Caption         =   "Save Buffer"
            Height          =   255
            Left            =   4800
            TabIndex        =   115
         ...
         Begin VB.CommandButton Command2 
            ...
            Width           =   855
         End
         Begin VB.CommandButton cmdStartFastReading 
            Caption         =   "START"
            Height          =   255
            Left            =   4320
            TabIndex        =   111
...
' BUFFER
Private Const maxB As Long = 100
Dim buff1(1 To maxB) As Double
Dim buff2(1 To maxB) As Double
Dim buff3(1 To maxB) As Double
...
Private Sub read_raw()
  ...
  buff2(couB) = reading_from_all_devices
  ' ********************************************************************************
...
Private Sub read_raw_check()
  ...
  buff2(couB) = couB 'Val(reading_from_each_instrument(1)) * 1000 ' in mV
  ' ********************************************************************************
         
  
  buff3(couB) = couB * 2 'Val(reading_from_each_instrument(0)) ' in V
...
Private Sub cmdStartFastReading_Click()
List1.Clear
  tmrReadDevices.Enabled = False
  tmrReadDevicesOnlyToDisplay.Enabled = False
...
'On Error GoTo myErrorHandler
  ...
  reading_from_each_instrument(0) = reading_from_all_devices
  ''Exit Sub
''myErrorHandler:
''  Dim msg As String
  'Call turn_off_all_timers
...
Private Function filter_result_is_OK() As Boolean
  ...
  If Val(txtDeltaCount.text) <= 0 Or Not IsNumeric(txtDeltaCount.text) Or _
