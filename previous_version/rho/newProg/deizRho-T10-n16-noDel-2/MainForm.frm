...
Begin VB.Form frmMainForm 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         Tab(0).Control(20)=   "Command5"
         Tab(0).Control(20).Enabled=   0   'False
         Tab(0).Control(21)=   "List1"
         Tab(0).Control(21).Enabled=   0   'False
         Tab(0).Control(22)=   "Command8"
         Tab(0).Control(22).Enabled=   0   'False
         Tab(0).Control(23)=   "Command9"
         Tab(0).Control(23).Enabled=   0   'False
         Tab(0).Control(24)=   "Command10"
         Tab(0).Control(24).Enabled=   0   'False
         Tab(0).ControlCount=   25
         TabCaption(1)   =   "Program"
         TabPicture(1)   =   "MainForm.frx":0DEE
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "chkDeltaMode"
         Tab(1).Control(1)=   "txtStopTime"
         Tab(1).Control(2)=   "txtCurrent"
         Tab(1).Control(3)=   "txtCompliance"
         Tab(1).Control(4)=   "txtDeltaCount"
         Tab(1).Control(5)=   "txtDelay"
         Tab(1).Control(6)=   "cboDigitalFilter"
         Tab(1).Control(7)=   "txtDigitalFilterCount"
         Tab(1).Control(8)=   "txtRate"
         Tab(1).Control(9)=   "cboAnalogFilter"
         Tab(1).Control(10)=   "cboVoltageRange"
         Tab(1).Control(11)=   "VScroll1"
         Tab(1).Control(12)=   "txtDataPoints"
         Tab(1).Control(13)=   "Command6"
         Tab(1).Control(14)=   "Command7"
         Tab(1).Control(15)=   "lstSchedulle"
         Tab(1).Control(16)=   "Label2"
         Tab(1).Control(17)=   "Label1"
         Tab(1).Control(18)=   "Label41"
         Tab(1).Control(19)=   "Label40"
         Tab(1).Control(20)=   "Label39"
         Tab(1).Control(21)=   "Label38"
         Tab(1).Control(22)=   "Label37"
         Tab(1).Control(23)=   "Label36"
         Tab(1).Control(24)=   "Label35"
         Tab(1).Control(25)=   "Label34"
         Tab(1).Control(26)=   "Label33"
         Tab(1).Control(27)=   "Label32"
         Tab(1).Control(28)=   "Label27"
         Tab(1).Control(29)=   "Label25"
         Tab(1).Control(30)=   "Label4(0)"
         Tab(1).Control(31)=   "Label5"
...
'On Error GoTo myErrorHandler
  ...
  ''reading_from_all_devices = Space$(200)
  reading_from_all_devices = Space$(30)
  ' Send command or query
  ...
  List1.AddItem reading_from_all_devices & " " & tim
