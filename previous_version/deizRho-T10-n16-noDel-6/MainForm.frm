...
Begin VB.Form frmMainForm 
   ...
   Begin VB.Frame frameDevices 
      ...
      Begin VB.TextBox txtAddress 
         ...
         TabIndex        =   73
         Text            =   "12,1,7"
         ToolTipText     =   "Address of 6220=12, 2182A=7, 3874A=1"
         Top             =   360
         Width           =   735
      End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabCaption(2)   =   "Run"
         TabPicture(2)   =   "MainForm.frx":0E0A
         Tab(2).ControlEnabled=   -1  'True
         Tab(2).Control(0)=   "Line1"
         Tab(2).Control(0).Enabled=   0   'False
         Tab(2).Control(1)=   "Line2"
         Tab(2).Control(1).Enabled=   0   'False
         Tab(2).Control(2)=   "Line3"
         Tab(2).Control(2).Enabled=   0   'False
         Tab(2).Control(3)=   "lblInfo(0)"
         Tab(2).Control(3).Enabled=   0   'False
         Tab(2).Control(4)=   "lblInfo(1)"
         Tab(2).Control(4).Enabled=   0   'False
         Tab(2).Control(5)=   "lblInfo(2)"
         Tab(2).Control(5).Enabled=   0   'False
         Tab(2).Control(6)=   "lblInfo(3)"
         Tab(2).Control(6).Enabled=   0   'False
         Tab(2).Control(7)=   "Line4"
         Tab(2).Control(7).Enabled=   0   'False
         Tab(2).Control(8)=   "tmrFastReading"
         Tab(2).Control(8).Enabled=   0   'False
         Tab(2).Control(9)=   "tmrRead2182"
         Tab(2).Control(9).Enabled=   0   'False
         Tab(2).Control(10)=   "cmdTurnOn6220"
         Tab(2).Control(10).Enabled=   0   'False
         Tab(2).Control(11)=   "cmdRead2182Multi"
         Tab(2).Control(11).Enabled=   0   'False
         Tab(2).Control(12)=   "cmdStopRead2182"
         Tab(2).Control(12).Enabled=   0   'False
         Tab(2).Control(13)=   "cmdStartRead2821"
         Tab(2).Control(13).Enabled=   0   'False
         Tab(2).Control(14)=   "txtInterval2182"
         Tab(2).Control(14).Enabled=   0   'False
         Tab(2).Control(15)=   "cmdSetup2182"
         Tab(2).Control(15).Enabled=   0   'False
         Tab(2).Control(16)=   "cmdRead2182"
         Tab(2).Control(16).Enabled=   0   'False
         Tab(2).Control(17)=   "cmdInitAll"
         Tab(2).Control(17).Enabled=   0   'False
         Tab(2).Control(18)=   "txtTotalPts"
         Tab(2).Control(18).Enabled=   0   'False
         Tab(2).Control(19)=   "cmdStartFastReadingTemp"
         Tab(2).Control(19).Enabled=   0   'False
         Tab(2).Control(20)=   "txtIntervalFastTimer"
         Tab(2).Control(20).Enabled=   0   'False
         Tab(2).Control(21)=   "cmdReadTemperature"
         Tab(2).Control(21).Enabled=   0   'False
         Tab(2).Control(22)=   "cmdClearList"
         Tab(2).Control(22).Enabled=   0   'False
         Tab(2).Control(23)=   "cmdStopReadEmf"
         Tab(2).Control(23).Enabled=   0   'False
         Tab(2).Control(24)=   "cmdReadTempMulti1"
         Tab(2).Control(24).Enabled=   0   'False
         Tab(2).Control(25)=   "cmdReadTempMulti2"
         Tab(2).Control(25).Enabled=   0   'False
         Tab(2).Control(26)=   "cmdReadAll"
         Tab(2).Control(26).Enabled=   0   'False
         Tab(2).Control(27)=   "txtTotalPointsAll"
         Tab(2).Control(27).Enabled=   0   'False
         Tab(2).Control(28)=   "cmdSaveReadAll"
         Tab(2).Control(28).Enabled=   0   'False
         Tab(2).Control(29)=   "tmrReadTc"
         Tab(2).Control(29).Enabled=   0   'False
         Tab(2).Control(30)=   "cmdStopReadAll"
         Tab(2).Control(30).Enabled=   0   'False
         Tab(2).Control(31)=   "cmdReadTandV"
         Tab(2).Control(31).Enabled=   0   'False
         Tab(2).ControlCount=   32
         Begin VB.CommandButton cmdReadTandV 
            BackColor       =   &H00FFFF80&
            Caption         =   "T (C) && V"
            Height          =   255
            Left            =   5040
            Style           =   1  'Graphical
            TabIndex        =   136
            ToolTipText     =   "Read the current T(C) and V"
            Top             =   1680
            Width           =   855
         End
         Begin VB.CommandButton cmdStopReadAll 
            BackColor       =   &H00FFFF80&
            Caption         =   "Stop"
            Height          =   375
            Left            =   2880
            Style           =   1  'Graphical
            TabIndex        =   135
            ToolTipText     =   "Press this button if you want to stop the running measurements"
            Top             =   2760
            Width           =   975
         End
         Begin VB.Timer tmrReadTc 
            Left            =   4560
            Top             =   1560
         End
         Begin VB.CommandButton cmdSaveReadAll 
            BackColor       =   &H00FFFF80&
            Caption         =   "Save File"
            Height          =   375
            Left            =   240
            Style           =   1  'Graphical
            TabIndex        =   132
            ToolTipText     =   "Save the measurements data to a file"
            Top             =   3240
            Width           =   1095
         End
         Begin VB.TextBox txtTotalPointsAll 
            BackColor       =   &H0080FF80&
            Height          =   285
            Left            =   1440
            TabIndex        =   131
            Text            =   "10"
            ToolTipText     =   "Total points to be measured ( typical fast reading: 70 ms per point)"
            Top             =   2760
            Width           =   975
         End
         Begin VB.CommandButton cmdReadAll 
            ...
            Style           =   1  'Graphical
            TabIndex        =   130
            ToolTipText     =   "Start the measurement; T(C) and V will be measured"
            Top             =   2760
            Width           =   1095
         End
         Begin VB.CommandButton cmdReadTempMulti2 
            Caption         =   "Read T Multi 2"
            Height          =   255
            Left            =   120
            TabIndex        =   126
            ToolTipText     =   "Check 10 readings. Col 1 meas time Col 2 T(C)"
            Top             =   2280
            Width           =   1215
         End
         Begin VB.CommandButton cmdReadTempMulti1 
            Caption         =   "Read T Multi 1"
            Height          =   255
            Left            =   120
            TabIndex        =   125
            ToolTipText     =   "Check 10 readings. Col 1 meas time Col 2 emf"
            Top             =   1920
            Width           =   1215
         End
         Begin VB.CommandButton cmdStopReadEmf 
            Caption         =   "STOP"
            Height          =   255
            Left            =   1440
            TabIndex        =   124
         ...
         Begin VB.CommandButton cmdClearList 
            ...
            Left            =   5040
            TabIndex        =   123
            ToolTipText     =   "Clear this right list box"
            Top             =   2280
            Width           =   855
         End
         Begin VB.CommandButton cmdReadTemperature 
            Caption         =   "Read T"
            Height          =   255
            Left            =   120
            TabIndex        =   122
            ToolTipText     =   "Read the emf. Col 1 meas time Col 2 emf. Ignore Col 3"
            Top             =   1560
            Width           =   1095
         End
         Begin VB.TextBox txtIntervalFastTimer 
            Height          =   285
            Left            =   2280
            TabIndex        =   121
            Text            =   "1000"
            ...
            Width           =   615
         End
         Begin VB.CommandButton cmdStartFastReadingTemp 
            Caption         =   "START"
            Height          =   255
            Left            =   1440
            TabIndex        =   120
            ToolTipText     =   "Read the emf with interval from right box. Col 1 meas time Col 2 emf. Ignore Col 3"
            Top             =   1560
            Width           =   735
         End
         Begin VB.TextBox txtTotalPts 
            Height          =   285
            Left            =   2280
            TabIndex        =   119
            Text            =   "10"
         ...
         Begin VB.CommandButton cmdInitAll 
            ...
            Style           =   1  'Graphical
            TabIndex        =   118
            ToolTipText     =   "This button MUST be pressed first after the software opened"
            Top             =   480
            Width           =   975
         End
         Begin VB.CommandButton cmdRead2182 
            Caption         =   "Read 2182"
            Height          =   255
            Left            =   120
            TabIndex        =   117
            ToolTipText     =   "Read the voltage. 1st col is V 2nd col is the measurement time"
            Top             =   960
            Width           =   975
         End
         Begin VB.CommandButton cmdSetup2182 
            BackColor       =   &H00FFFF80&
            Caption         =   "Set 2182"
            Height          =   255
            Left            =   3120
            Style           =   1  'Graphical
            TabIndex        =   116
            ToolTipText     =   $"MainForm.frx":0E26
            Top             =   480
            Width           =   975
         End
         Begin VB.TextBox txtInterval2182 
            Height          =   285
            Left            =   5160
            TabIndex        =   115
            Text            =   "1000"
            ...
            Width           =   495
         End
         Begin VB.CommandButton cmdStartRead2821 
            Caption         =   "START"
            Height          =   375
            Left            =   3600
            TabIndex        =   114
            ToolTipText     =   "Read the voltage with interval set in right box.  1st col is V 2nd col is the measurement time"
            Top             =   960
            Width           =   735
         End
         Begin VB.CommandButton cmdStopRead2182 
            Caption         =   "STOP"
            Height          =   375
            Left            =   4440
            TabIndex        =   113
            ToolTipText     =   "Stop the voltage reading"
            Top             =   960
            Width           =   615
         End
         Begin VB.CommandButton cmdRead2182Multi 
            Caption         =   "Read Multi"
            Height          =   255
            Left            =   1200
            TabIndex        =   112
            ToolTipText     =   "read the voltage (iterative) for total points set in the right box.  1st col is V 2nd col is the measurement time."
            Top             =   960
            Width           =   975
         End
         Begin VB.CommandButton cmdTurnOn6220 
            BackColor       =   &H00FFFF80&
            Caption         =   "6220 ON"
            Height          =   255
            Left            =   1920
         ...
         Begin VB.ComboBox cboDigitalFilter 
            BackColor       =   &H00C0FFC0&
            Height          =   315
            ItemData        =   "MainForm.frx":0F70
            Left            =   -70560
            List            =   "MainForm.frx":0F7D
            TabIndex        =   80
            Text            =   "None"
            Top             =   2160
            Width           =   1215
         ...
         Begin VB.ComboBox cboAnalogFilter 
            BackColor       =   &H00C0FFC0&
            Height          =   315
            ItemData        =   "MainForm.frx":0F97
            Left            =   -70560
            List            =   "MainForm.frx":0FA1
            TabIndex        =   77
            Text            =   "OFF"
            Top             =   1800
            Width           =   1215
         ...
         Begin VB.ComboBox cboVoltageRange 
            BackColor       =   &H00C0FFC0&
            Height          =   315
            ItemData        =   "MainForm.frx":0FAE
            Left            =   -70200
            List            =   "MainForm.frx":0FC4
            TabIndex        =   76
            Text            =   "Auto"
            Top             =   3240
            Width           =   855
         ...
         Begin VB.ListBox lstSchedulle 
            Height          =   645
            ItemData        =   "MainForm.frx":0FF0
            Left            =   -74880
            List            =   "MainForm.frx":0FFD
            TabIndex        =   37
            Top             =   480
            Width           =   4215
         End
         Begin VB.Timer tmrRead2182 
            Enabled         =   0   'False
            Left            =   4920
            Top             =   960
         End
         Begin VB.Timer tmrFastReading 
            Enabled         =   0   'False
            Interval        =   1000
            Left            =   1800
            Top             =   1560
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ListBox List1 
         Height          =   4350
         ItemData        =   "MainForm.frx":1073
         Left            =   240
         List            =   "MainForm.frx":1075
         TabIndex        =   134
         Top             =   1200
         Width           =   8295
      End
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":180D
               Key             =   "data"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":1C61
               Key             =   "go"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":1DBD
               Key             =   "stop"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":20D7
               Key             =   "pause"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":2529
               Key             =   "chart"
            EndProperty
         EndProperty
      End
      Begin MSComctlLib.ImageList ImageList2 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            NumListImages   =   5
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":297D
               Key             =   "data"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":2DD1
               Key             =   "go"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":2F2D
               Key             =   "stop"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":3247
               Key             =   "pause"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":3699
               Key             =   "chart"
            EndProperty
         EndProperty
      End
      Begin VB.ComboBox cmbSelectYAxis 
         Height          =   315
         ItemData        =   "MainForm.frx":3AED
         Left            =   4920
         List            =   "MainForm.frx":3B06
         TabIndex        =   15
         Text            =   "Resistivity"
         Top             =   600
         Width           =   1455
      ...
      Begin VB.ComboBox cmbSelectXAxis 
         Height          =   315
         ItemData        =   "MainForm.frx":3B58
         Left            =   3240
         List            =   "MainForm.frx":3B68
         TabIndex        =   14
         Text            =   "Temperature"
         Top             =   600
         Width           =   1455
...
' BUFFER
Private Const maxB As Long = 10
Dim buff1() As Double
Dim buff2() As Double
Dim buff3() As Double
Dim couB As Long ' buffer array count per save, every maxB
Dim couF As Long ' buffer file count, after maxB reached saved
...
Private Sub cmdReadAll_Click()
  ...
  tmrFastReading.Enabled = False
  tmrReadTc.Enabled = False
  tmrRead2182.Enabled = False
    
  Erase buff1
  Erase buff2
  Erase buff3
    
  ReDim Preserve buff1(1 To Val(txtTotalPointsAll))
  ReDim Preserve buff2(1 To Val(txtTotalPointsAll))
  ReDim Preserve buff3(1 To Val(txtTotalPointsAll))
    
  ' *** OK if want to see exec time *******************
  Call startTiming(timReturn, timFreq, timStart)
  ' ***************************************************
  
  isStop = False ' IMPORTANT
  
  ' *******************
  Call read_raw_all
  ' *******************
  
  MsgBox "Measurements DONE. The measurements data NOT saved yet."
End Sub
...
Private Sub cmdReadT_Click()
  ...
  tmrReadTc.Interval = Val(txtIntervalFastTimer.text)
  tmrReadTc.Enabled = True
End Sub

Private Sub cmdReadTandV_Click()
  cboDisplay(0).text = ""
  cboDisplay(1).text = ""
  cboDisplay(2).text = ""
  cboDisplay(3).text = ""
...
Private Sub cmdReadTemperature_Click()
  tmrReadDevices.Enabled = False
  tmrReadDevicesOnlyToDisplay.Enabled = False
  ...
  ReDim Preserve buff1(1 To maxB)
  ReDim Preserve buff2(1 To maxB)
  ReDim Preserve buff3(1 To maxB)
...
Private Sub read_raw_OK()
  ...
  'Dim emf2 As Double
  buff2(couB) = Val(reading_from_each_instrument(1)) * 1000 ' in mV
  ' ********************************************************************************
         
  'voltage2 = Val(reading_from_each_instrument(0)) ' in V
  buff3(couB) = Val(reading_from_each_instrument(0)) ' in V
 
    
  ' *** OK if want to see exec time ******************************************************
  ''lblExecTime.Caption = "Calc. time: " & Round(execTime(timReturn, timFreq, timStart, timEnd), 4) & " ms"
  ' ************************************************************************************************
  'Dim timElap As Double
  'timElap = execTime(timReturn, timFreq, timStart, timEnd)
  buff1(couB) = execTime(timReturn, timFreq, timStart, timEnd)
  
  'MsgBox Round(timElap, 4) & " ms"
  List1.AddItem buff1(couB) & " " & buff2(couB) & " " & buff3(couB)
  
  If couB >= maxB Then
    Debug.Print couF
    couF = couF + 1
    Call saveBuffer(couF)
    couB = 0
  End If
...
Private Sub readTc()
  ...
  ' Temperature; Reading temperature from HP DMM = Dev(1) *********
    emfR = Space$(&H32)
    
    Call ilrd(Dev(1), emfR, Len(emfR))
    If (ibsta And EERR) Then
      GpibErr ("Error receiving response from HP 3478A.")
    End If
  
    emf2 = Val(emfR) * 1000 ' in mV
    If emf2 < 0 Then ' -230 - 0 C (-5.891 mV to 0 mV), K Thermocouple
      Tc = (25.173462 * emf2) - (1.1662878 * emf2 ^ 2) - _
    ...
    ElseIf emf2 < 20.644 Then ' 0 - 500 C (0 mV to 20.644 mV), K Thermocouple
      Tc = (25.08355 * emf2) + (0.07860106 * emf2 ^ 2) - _
    ...
    Else  ' 500 - 1372 C (20.644 mV to 54.886 mV), K Thermocouple
      Tc = -131.8058 + (48.30222 * emf2) - (1.646031 * emf2 ^ 2) + _
      (0.05464731 * emf2 ^ 3) - (0.0009650715 * emf2 ^ 4) + _
      (0.000008802193 * emf2 ^ 5) - (0.0000000311081 * emf2 ^ 6)
    End If
    
    cboDisplay(1).text = Tc
End Sub

Private Sub readV()
  Dim emfRaw As String
  ...
  ' Receive response
  Call ilrd(Dev(2), emfRaw, Len(emfRaw))
  If (ibsta And EERR) Then
    GpibErr ("Error receiving response of 'read?'")
  End If
    
  cboDisplay(3).text = emfRaw
End Sub

Private Sub read_raw_all()
  ...
  Dim voltRaw As String
   
  For i = 1 To Val(txtTotalPointsAll)
    DoEvents
    
    ' Voltage reading from 2182 Nanovoltmeter ****************************************************
    voltRaw = Space$(30)
    ' Send command or query
    Call ilwrt(Dev(2), ":read?", 6)
    If (ibsta And EERR) Then
    ...
    ' Receive response
    Call ilrd(Dev(2), voltRaw, Len(voltRaw))
    If (ibsta And EERR) Then
      GpibErr ("Error receiving response of 'read?'")
    End If
    ...
    emf2 = Val(emfR) * 1000 ' in mV
    If emf2 < 0 Then ' -230 - 0 C (-5.891 mV to 0 mV), K Thermocouple
      buff2(i) = (25.173462 * emf2) - (1.1662878 * emf2 ^ 2) - _
      (1.0833638 * emf2 ^ 3) - (0.8977354 * emf2 ^ 4) - _
      (0.37342377 * emf2 ^ 5) - (0.086632643 * emf2 ^ 6) - _
      (0.010450598 * emf2 ^ 7) - (0.00051920577 * emf2 ^ 8)
    ElseIf emf2 < 20.644 Then ' 0 - 500 C (0 mV to 20.644 mV), K Thermocouple
      buff2(i) = (25.08355 * emf2) + (0.07860106 * emf2 ^ 2) - _
      (0.2503131 * emf2 ^ 3) + (0.0831527 * emf2 ^ 4) - _
      (0.01228034 * emf2 ^ 5) + (0.0009804036 * emf2 ^ 6) - _
      (0.0000441303 * emf2 ^ 7) + (0.000001057734 * emf2 ^ 8) - _
      (0.00000001052755 * emf2 ^ 9)
    Else  ' 500 - 1372 C (20.644 mV to 54.886 mV), K Thermocouple
      buff2(i) = -131.8058 + (48.30222 * emf2) - (1.646031 * emf2 ^ 2) + _
      (0.05464731 * emf2 ^ 3) - (0.0009650715 * emf2 ^ 4) + _
      (0.000008802193 * emf2 ^ 5) - (0.0000000311081 * emf2 ^ 6)
    End If
    ' ********************************************************************************
    ...
    ' Time *************************************************************
    buff1(i) = execTime(timReturn, timFreq, timStart, timEnd)
    ' ******************************************************************
  
    cboDisplay(0).text = buff1(i)
    cboDisplay(1).text = buff2(i)
    cboDisplay(3).text = buff3(i)
    
    If isStop = True Then Exit Sub
  Next i
  
End Sub

Public Sub saveBuffer(coun As Long)
  mFileSysObj.CreateTextFile ("c:\bu" & coun) 'if already there, destroying the old file
  Set mFile = mFileSysObj.GetFile("c:\bu" & coun)
  Set mTxtStream = mFile.OpenAsTextStream(ForWriting)
            
  Dim i As Long
      
  For i = 1 To maxB
    Call mTxtStream.WriteLine(buff1(i) & " " & buff2(i) & " " & buff3(i))
  Next i
      
  Call mTxtStream.Close 'closing file for writing
End Sub

Private Sub read_raw()
  ...
  buff3(couB) = 1 'Val(reading_from_each_instrument(0)) ' in V
...
Private Sub read_raw_Check()
  ...
  List1.AddItem timElap

End Sub
  

Private Sub cmdSaveBuffer_Click()

End Sub

Private Sub cmdSaveReadAll_Click()
  On Error Resume Next
  ...
  ' **********************
  Call save_file_NEW(isSuccess)
  ' **********************
  
  If isSuccess = True Then
    MsgBox "Measurement data SAVED"
  End If
End Sub

Private Sub cmdStartFastReadingTemp_Click()
  tmrReadDevices.Enabled = False
  tmrReadDevicesOnlyToDisplay.Enabled = False
  ...
  tmrFastReading.Interval = Val(txtIntervalFastTimer.text)
  tmrFastReading.Enabled = True
End Sub

Private Sub cmdStopReadAll_Click()
  isStop = True
End Sub

Private Sub cmdStopReadEmf_Click()
  tmrFastReading.Enabled = False
  tmrReadTc.Enabled = False
End Sub


Private Sub cmdReadTempMulti2_Click()
  ...
  Dim time As Double
  time = execTime(timReturn, timFreq, timStart, timEnd)
  
  'MsgBox Round(timElap, 4) & " ms"
  List1.AddItem time & " " & Temperature2 'emf2
  
  Next i
  
End Sub

Private Sub cmdReadTempMulti1_Click()
  tmrReadDevices.Enabled = False
  tmrReadDevicesOnlyToDisplay.Enabled = False
  ...
  Dim buffT(1 To 10) As Double
  Dim time(1 To 10) As Double
 ...
 For i = LBound(buffT) To UBound(buffT)
  ...
  ''emf2 = reading_from_all_devices
 
  
  
    buffT(i) = reading_from_all_devices
    time(i) = execTime(timReturn, timFreq, timStart, timEnd)
  
  Next i
  
  For i = LBound(buffT) To UBound(buffT)
    List1.AddItem time(i) & " " & buffT(i)
  Next i
  
End Sub

Private Sub tmrFastReading_Timer()
  Call read_raw
End Sub

' *** TEMPERATURE READEING ENDS *****

Private Sub cmdTurnOn6220_Click()
  Dim command As String
  Dim k As Integer
  
  k = 0 'Val(txtDeviceNumber.text)
  ...
  Call ilwrt(Dev(k), command, Len(command))
  If (ibsta And EERR) Then
    GpibErr "Error setting current range"
  End If
...
Private Sub cmdSetup2182_Click()
  ...
  Call ilwrt(Dev(k), ":samp:coun 1", 12)
  If (ibsta And EERR) Then
    GpibErr ("Error sending ':samp:coun 1'. ")
  End If
  ' ******
End Sub

Private Sub cmdStartRead2821_Click()
  tmrReadDevices.Enabled = False
  tmrReadDevicesOnlyToDisplay.Enabled = False
  ...
  tmrRead2182.Interval = Val(txtInterval2182.text)
  tmrRead2182.Enabled = True
End Sub

Private Sub cmdStopRead2182_Click()
  tmrRead2182.Enabled = False
End Sub

Private Sub cmdRead2182Multi_Click()
  Dim i As Long
  ...
  For i = 1 To Val(txtTotalPts.text)
    Call read_2182
  Next i
End Sub
...
Private Sub read_2182() ' Dev(2) = Keithley 2821
'On Error GoTo myErrorHandler
  Dim emfRaw As String
  ...
  ''txtResponse.text = reading_from_all_devices & " " & execTime(timReturn, timFreq, timStart, timEnd)
    
  Dim tim As Double
  tim = execTime(timReturn, timFreq, timStart, timEnd)
    
  List1.AddItem emfRaw & " " & tim
...
Public Sub save_file_NEW(isSuccess As Boolean)
On Error GoTo myErrorHandler
  isSuccess = False

  path_and_file_name = txtFile.text
  
  If mFileSysObj.FileExists(path_and_file_name) = True Then
    Dim answer As Long
    
    answer = MsgBox(path_and_file_name & " already exists. Overwrite file ?", vbYesNo, "Overwrite File")
    If answer = vbYes Then
      'Kill file_name ' file_name will be passed to the calling sub, but the existed filename will be deleted first
      ' file_name will be passed to the calling sub & the file will be deleted if created in the save sub
    Else
      MsgBox "The measurement data NOT saved yet. Make a new file name !"
  ...
  experiment_info = experiment_info & "Time(ms) " & "Temperature(oC) " & _
    "Resistivity(Ohm.m) " & "Resistance(Ohm) " & "Voltage(V) " & "Current(A)"
      
  'experiment_info = experiment_info & "Time(ms) " & "Temperature(oC) " & "Voltage(V)"
  
  mTxtStream.WriteLine (experiment_info)
      
  current2 = Val(txtCurrent.text) / 1000 ' in A 'Val(reading_from_each_instrument(2))
  
  For i = 1 To Val(txtTotalPointsAll.text) 'times_of_readings
    'Call mTxtStream.WriteLine(time_elapsed(i) & " " & Temperature(i) & " " & _
      resistivity(i) & " " & resistance(i) & " " & voltage(i) & " " & _
      current(i) & " " & hhmmss(time_elapsed(i)))
      
    If current2 <> 0 Then
      resistance2 = buff3(i) / current2 'Round(buff3(i) / current2, 13) ' in Ohm
    Else
      resistance2 = buff3(i) / 0.000001 'Round(buff3(i) / 0.000001, 13) ' this is to avoid dividing by 0
    End If
  
    resistivity2 = resistance2 * Rho_factor 'Round(resistance2 * Rho_factor, 14) ' in Ohm.m
     
    Call mTxtStream.WriteLine(buff1(i) & " " & buff2(i) & " " & resistivity2 & " " & resistance2 & " " & buff3(i) & " " & current2)
  Next i
...
Private Sub tmrRead2182_Timer()
  Call read_2182
End Sub

Private Sub tmrReadTc_Timer()
  Call readTc
