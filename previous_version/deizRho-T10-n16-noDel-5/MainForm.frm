...
Begin VB.Form frmMainForm 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         Tab(2).Control(7)=   "tmrFastReading"
         Tab(2).Control(7).Enabled=   0   'False
         Tab(2).Control(8)=   "tmrRead2182"
         Tab(2).Control(8).Enabled=   0   'False
         Tab(2).Control(9)=   "cmdTurnOn6220"
         Tab(2).Control(9).Enabled=   0   'False
         Tab(2).Control(10)=   "cmdRead2182Multi"
         Tab(2).Control(10).Enabled=   0   'False
         Tab(2).Control(11)=   "cmdStopRead2182"
         Tab(2).Control(11).Enabled=   0   'False
         Tab(2).Control(12)=   "cmdStartRead2821"
         Tab(2).Control(12).Enabled=   0   'False
         Tab(2).Control(13)=   "txtInterval2182"
         Tab(2).Control(13).Enabled=   0   'False
         Tab(2).Control(14)=   "cmdSetup2182"
         Tab(2).Control(14).Enabled=   0   'False
         Tab(2).Control(15)=   "cmdRead2182"
         Tab(2).Control(15).Enabled=   0   'False
         Tab(2).Control(16)=   "cmdInitAll"
         Tab(2).Control(16).Enabled=   0   'False
         Tab(2).Control(17)=   "txtTotalPts"
         Tab(2).Control(17).Enabled=   0   'False
         Tab(2).Control(18)=   "cmdStartFastReadingTemp"
         Tab(2).Control(18).Enabled=   0   'False
         Tab(2).Control(19)=   "txtIntervalFastTimer"
         Tab(2).Control(19).Enabled=   0   'False
         Tab(2).Control(20)=   "cmdReadTemperature"
         Tab(2).Control(20).Enabled=   0   'False
         Tab(2).Control(21)=   "cmdClearList"
         Tab(2).Control(21).Enabled=   0   'False
         Tab(2).Control(22)=   "cmdStopReadEmf"
         Tab(2).Control(22).Enabled=   0   'False
         Tab(2).Control(23)=   "cmdReadTempMulti1"
         Tab(2).Control(23).Enabled=   0   'False
         Tab(2).Control(24)=   "cmdReadTempMulti2"
         Tab(2).Control(24).Enabled=   0   'False
         Tab(2).Control(25)=   "cmdReadAll"
         Tab(2).Control(25).Enabled=   0   'False
         Tab(2).Control(26)=   "txtTotalPointsAll"
         Tab(2).Control(26).Enabled=   0   'False
         Tab(2).Control(27)=   "cmdSaveReadAll"
         Tab(2).Control(27).Enabled=   0   'False
         Tab(2).Control(28)=   "cmdReadT"
         ...
         Begin VB.Timer tmrReadTc 
            ...
            Top             =   1560
         End
         Begin VB.CommandButton cmdReadT 
            Caption         =   "T (C)"
            Height          =   255
            Left            =   4920
            TabIndex        =   135
         ...
         Begin VB.ComboBox cboDigitalFilter 
            Height          =   315
            ItemData        =   "MainForm.frx":0E26
            Left            =   -70560
            List            =   "MainForm.frx":0E33
            TabIndex        =   80
            Text            =   "None"
            Top             =   2160
            Width           =   1215
         ...
         Begin VB.ComboBox cboAnalogFilter 
            Height          =   315
            ItemData        =   "MainForm.frx":0E4D
            Left            =   -70560
            List            =   "MainForm.frx":0E57
            TabIndex        =   77
            Text            =   "OFF"
            Top             =   1800
            Width           =   1215
         ...
         Begin VB.ComboBox cboVoltageRange 
            Height          =   315
            ItemData        =   "MainForm.frx":0E64
            Left            =   -70200
            List            =   "MainForm.frx":0E7A
            TabIndex        =   76
            Text            =   "Auto"
            Top             =   3240
            Width           =   855
         ...
         Begin VB.ListBox lstSchedulle 
            Height          =   645
            ItemData        =   "MainForm.frx":0EA6
            Left            =   -74880
            List            =   "MainForm.frx":0EB3
            TabIndex        =   37
            Top             =   480
            Width           =   4215
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ListBox List1 
         Height          =   4350
         ItemData        =   "MainForm.frx":0F29
         Left            =   240
         List            =   "MainForm.frx":0F2B
         TabIndex        =   134
         Top             =   1200
         Width           =   8295
      End
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":16C3
               Key             =   "data"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":1B17
               Key             =   "go"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":1C73
               Key             =   "stop"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":1F8D
               Key             =   "pause"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":23DF
               Key             =   "chart"
            EndProperty
         EndProperty
      End
      Begin MSComctlLib.ImageList ImageList2 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            NumListImages   =   5
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":2833
               Key             =   "data"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":2C87
               Key             =   "go"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":2DE3
               Key             =   "stop"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":30FD
               Key             =   "pause"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "MainForm.frx":354F
               Key             =   "chart"
            EndProperty
         EndProperty
      End
      Begin VB.ComboBox cmbSelectYAxis 
         Height          =   315
         ItemData        =   "MainForm.frx":39A3
         Left            =   4920
         List            =   "MainForm.frx":39BC
         TabIndex        =   15
         Text            =   "Resistivity"
         Top             =   600
         Width           =   1455
      ...
      Begin VB.ComboBox cmbSelectXAxis 
         Height          =   315
         ItemData        =   "MainForm.frx":3A0E
         Left            =   3240
         List            =   "MainForm.frx":3A1E
         TabIndex        =   14
         Text            =   "Temperature"
         Top             =   600
         Width           =   1455
...
Private Sub read_raw_all()
  ...
  For i = 1 To Val(txtTotalPointsAll)
    ...
    'List1.AddItem buff1(i) & " " & buff2(i) 'emf2
...
Private Sub cmdReadTempMulti1_Click()
  Dim buffT(1 To 3) As Double
  Dim time(1 To 3) As Double
...
Private Sub cmdSetup2182_Click()
  ...
  Call ilwrt(Dev(2), ":samp:coun 1", 12)
  If (ibsta And EERR) Then
...
On Error GoTo myErrorHandler
  ...
  experiment_info = experiment_info & "Time(s) " & "Temperature(oC) " & "Voltage(V)"
